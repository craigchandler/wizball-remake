#ifndef PLATFORM_SCANCODES_H
#define PLATFORM_SCANCODES_H

// Allegro 4 compatible scancode values (0..114).
// These are used throughout the codebase as the canonical "scancode" indices.
// The SDL backend maps these to SDL_Scancode values.
